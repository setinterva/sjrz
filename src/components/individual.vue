    ...
    <div class="individual">
        ...
        <!-- 对私非法人结算 -->
            ...
            <div class="photo">
                ...
                <div v-else>
                    <input type="file" id="upload4" accept="image" @change="upload4" style="display: none;">  
            ...
            <div class="photo">
                ...
                <div v-else>
                    <input type="file" id="upload5" accept="image" @change="upload5" style="display: none;">  
            ...
            <div class="photo">
                ...
                <div v-else>
                    <input type="file" id="upload6" accept="image" @change="upload6" style="display: none;">  
            ...
            <div class="photo">
                ...
                <div v-else>
                    <input type="file" id="upload7" accept="image" @change="upload7" style="display: none;">  
...
<style>
.individual .tit>div:nth-child(1){
    display: none;
}
.individual .radio4>div{
    display: flex;
}
.individual .radio4>div>span:nth-of-type(2){
    flex: 1;
    padding-right: 20px;
}
</style>
