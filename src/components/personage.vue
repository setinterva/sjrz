<template>
    <div class="personage" style="display:flex;flex-direction: column;">
...
<div style="flex: 1;overflow-y: auto;width: 100%;">
            ...
            <van-cell-group>
                ...
                <p style="position: relative;"><van-field v-model="point" clearable label="扣点" placeholder="请输入扣点(平台扣款比例0.25~90)" v-on:blur="change1(point)"/><span style="position: absolute;right: 15%;top: 25%;z-index: 9;">%</span></p>
        ...
        <div class="pic">
            ...
            <van-radio-group v-model="settle" style="margin-top: 20px;" class="radio4">
                <van-radio name="2" @click="username1='',banktype='',account='',popupVisible2 = true">开户人结算 <van-icon name="arrow" style="float: right;" /></van-radio>
            </van-radio-group>
    ...
    methods:{
        ...
        upload(e){                                                   //营业执照 
            ...
            reader.onload = function(e){
                ...
                image.onload = function(){  
                    ...
                    let dataUrl = canvas.toDataURL('image/jpeg', 0.6) // 7为压缩比，可根据需要设置，设置过小会影响图片质量  
        ...
        submit(){
                ...
                if(_this.settle == "2"){
                    ...
                    form.append("business_license",_this.cardid)
...
<style>
.personage .tit>div:nth-child(1){
    display: none;
}
.personage .radio4>div{
    display: flex;
}
.personage .radio4>div>span:nth-of-type(2){
    flex: 1;
    padding-right: 20px;
}
</style>
